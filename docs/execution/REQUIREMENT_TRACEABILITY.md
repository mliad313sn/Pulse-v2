...
| E09 Actions | quick-add actions, source links | **COMPLETE (core)** | actions entity (general+project, offline-capable, CANCELLED excluded), My Actions quick-add UI, RAG overdueWork now action-driven | actions.test.js GREEN; live walk | Remaining: meeting-sourced actions (E14), assignment notifications (E19) |
...
| E11 Risk/Roadblock/CAPA | risk register, roadblock lifecycle, CAPA workflow | **COMPLETE (core)** | 5-state roadblock lifecycle (reopen w/ reason, audited escalation, verify authz), risks w/ derived P×I + residuals, CAPA 6-state workflow + convert-from-roadblock | roadblock_lifecycle/risks/capa suites GREEN; live walk | Remaining: risk heatmaps (E22), escalation notifications (E19), CAPA effectiveness dashboards |
